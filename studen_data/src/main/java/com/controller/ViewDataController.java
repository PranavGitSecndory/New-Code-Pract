...
public class ViewDataController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<tr><th>RollNo</th><th>Name</th><th>Password</th><th>ContactNo</th><th>Email_id</th><th>Birht_date</th><th>city</th></tr>");
		
		for(student s :li)
		{
			pw.print("<tr><th>"+s.getRollNo()+"</th><th>"+s.getName()+"</th><th>"+s.getPassword()+"</th><th>"+s.getContactno()+"</th><th>"+s.getEmail()+"</th><th>"+s.getBirhtdate()+"</th><th>"+s.getCity()+"</th></tr>");
		}
