...
public class CoreBanking {
    ...
    static void signup() {
        try {
            ...
            File masterFile = new File(main_file);
            ...
            BufferedWriter bw = new BufferedWriter(new FileWriter(main_file, true));
    ...
    static void reports(String customerId) throws IOException {
        System.out.println("\n--- TRANSACTION REPORT ---");
        File transFile = new File(trasection_file);
        if(!transFile.exists()) {
    ...
    static void writeTransaction(String customerId, String type, double amt) throws IOException {
        BufferedWriter bw = new BufferedWriter(new FileWriter(trasection_file, true));
